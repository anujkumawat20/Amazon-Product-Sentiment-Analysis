...
🔗 **Dashboard File:** The Power BI dashboard (`.pbix`) is available on Google Drive (file size exceeds GitHub's recommended limit):
[View Dashboard File](https://drive.google.com/drive/folders/1ghquX-BkZj8R9THoYxQ3LAdFjpJpt15G?usp=sharing)
...
Open `Amazon_Product_Sentiment_Dashboard.pbix` (download from the [Google Drive link](https://drive.google.com/drive/folders/1ghquX-BkZj8R9THoYxQ3LAdFjpJpt15G?usp=sharing) above).
